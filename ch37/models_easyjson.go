...
func easyjsonD2b7633eDecodeGoLearningCh37(in *jlexer.Lexer, out *JobInfo) {
...
func easyjsonD2b7633eEncodeGoLearningCh37(out *jwriter.Writer, in JobInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v JobInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD2b7633eEncodeGoLearningCh37(&w, v)
...
func (v *JobInfo) UnmarshalJSON(data []byte) error {
	...
	easyjsonD2b7633eDecodeGoLearningCh37(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JobInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD2b7633eDecodeGoLearningCh37(l, v)
}
func easyjsonD2b7633eDecodeGoLearningCh371(in *jlexer.Lexer, out *Employee) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "basic_info":
			if in.IsNull() {
				...
				if out.BasicInfo == nil {
					out.BasicInfo = new(BasicInfo)
				}
...
func easyjsonD2b7633eEncodeGoLearningCh371(out *jwriter.Writer, in Employee) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Employee) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD2b7633eEncodeGoLearningCh371(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Employee) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD2b7633eDecodeGoLearningCh371(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Employee) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD2b7633eDecodeGoLearningCh371(l, v)
}
func easyjsonD2b7633eDecodeGoLearningCh372(in *jlexer.Lexer, out *BasicInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD2b7633eEncodeGoLearningCh372(out *jwriter.Writer, in BasicInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v BasicInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD2b7633eEncodeGoLearningCh372(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *BasicInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonD2b7633eDecodeGoLearningCh372(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BasicInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD2b7633eDecodeGoLearningCh372(l, v)
}
